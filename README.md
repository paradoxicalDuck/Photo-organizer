# Photo-organizer
This program takes jpegs and sort them chronological using meta data of pictures. Instead sorting them like windows using data of modification it uses date of creation file.
